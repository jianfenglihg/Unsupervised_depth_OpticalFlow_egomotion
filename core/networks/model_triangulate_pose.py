"""
given optical flow -> calculate relative pose -> calculate the distance between point and corresponding epipolar line
-> find rigid mask -> mask the distance -> calculate loss
"""
